...
class FindRecommendCell: UITableViewCell {
    
    static let cellIdentifier = "FindRecommendCell"
    ...
    lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(FindRecommendPicCell.self, forCellWithReuseIdentifier:FindRecommendPicCell.cellIdentifier)
...
extension FindRecommendCell: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.findRecommendSteam?.picUrls?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FindRecommendPicCell.cellIdentifier, for: indexPath) as! FindRecommendPicCell
